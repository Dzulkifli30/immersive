            ...
            <div class="flex-none w-full max-w-full px-3">
                <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                    <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent flex justify-between">
                        <h6>Berita table</h6>
                        <button onclick="showPopup('tambah-berita')" class="cursor-pointer flex p-2 m-1 rounded-md items-center bg-gradient-to-r from-lime-500 via-green-500 to-emerald-500 hover:bg-gradient-to-br text-white font-medium ">
                            <i class="fa fa-plus-circle pr-1" aria-hidden="true"></i> Tambah Berita
                        </button>
                    </div>
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                            <div class="flex justify-center">
                                                ...
                                                <a href="{{ route('berita.edit', $data->id) }}" class="cursor-pointer flex p-2 m-1 rounded-md items-center bg-gradient-to-r from-yellow-400 to-amber-500 hover:bg-gradient-to-br hover:to-amber-400 text-white font-medium ">
