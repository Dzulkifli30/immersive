      ...
      <div id="form" class="lg:w-2/3 mx-auto block">
        <div class="bg-white shadow border rounded-lg p-4">
          <form action="{{ route('price.update', $price->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="w-full">
              <div class="mb-4">
                <label for="jenis" class="block text-gray-700 text-lg font-bold mb-2">Masukan Jenis:</label>
                <input type="text" id="jenis" name="jenis" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  placeholder="Masukkan jenis" require value="{{$price->jenis}}">
              </div>
              <div class="mb-4">
                <label for="harga" class="block text-gray-700 text-lg font-bold mb-2">Masukan Harga:</label>
                <input type="number" id="harga" name="harga" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  placeholder="Masukkan harga" require value="{{$price->harga}}">
              </div>
              <div class="mb-4">
                ...
                <textarea id="isi" name="isi" rows="4" class="block p-2.5 w-full text-sm text-gray-700 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                  placeholder="Masukan Isi" require>{{$price->isi}}</textarea>
              </div>
