  ...
  <nav class="relative flex flex-wrap items-center justify-between px-0 py-2 mx-6 transition-all shadow-none duration-250 ease-soft-in rounded-2xl lg:flex-nowrap lg:justify-start" navbar-main navbar-scroll="true">
    <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
      <nav>
        ...
        <h6 class="mb-0 font-bold capitalize">FAQ</h6>
      </nav>
      ...
      <div class="flex-none w-full max-w-full px-3">
        <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
          <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent flex justify-between">
            <h6>Faq table</h6>
            <button onclick="showPopup('tambah-faq')" class="cursor-pointer flex p-2 m-1 rounded-md items-center bg-gradient-to-r from-lime-500 via-green-500 to-emerald-500 hover:bg-gradient-to-br text-white font-medium ">
              <i class="fa fa-plus-circle pr-1" aria-hidden="true"></i> Tambah FAQ
            </button>
          </div>
            ...
            <div class="p-0 overflow-x-auto">
              <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                <thead class="align-bottom">
                  <tr>
                    <th class="px-6 py-3 font-bold text-left uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">Pertanyaan</th>
                    <th class="px-6 py-3 pl-2 font-bold text-left uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">Jawaban</th>
                  ...
                  <tr>
                    <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                      <div class=" px-4 max-w-sm">
                        <h6 class="mb-0 text-base leading-normal break-words whitespace-normal line-clamp-1">{{$data->pertanyaan}}</h6>
                      </div>
                    </td>
                    <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                      <div class="max-w-md">
                        <h6 class="mb-0 text-sm leading-normal break-words whitespace-normal line-clamp-2">{{$data->isi}}</h6>
                      </div>
                    </td>
                    <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                      <div class="flex justify-center">
                        ...
                        <a href="{{ route('faqs.edit', $data->id) }}" class="cursor-pointer flex p-2 m-1 rounded-md items-center bg-gradient-to-r from-yellow-400 to-amber-500 hover:bg-gradient-to-br hover:to-amber-400 text-white font-medium ">
...
<div id="tambah-faq" class="fixed inset-0 hidden items-center justify-center bg-black bg-opacity-50">
  <div
    ...
    <div class="flex items-center justify-between p-3 px-6">
      <h3 class="text-xl font-bold">Tambah FAQ</h3>
      <button onclick="hidePopup('tambah-faq')" class="text-black font-bold px-2 py-1 rounded bg-primary-red">X</button>
    </div>
