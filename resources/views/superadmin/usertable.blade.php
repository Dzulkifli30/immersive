              ...
              <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                <thead class="align-bottom">
                  <tr>
                    ...
                    <th class="px-6 py-3 font-bold text-center uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">pajangan</th>
                  ...
                  <tr>
                    ...
                    <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                      <div class="flex justify-center">
                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('users.destroy', $data->id) }}" method="POST">
                          @csrf
                          @method('DELETE')
                        ...
                        <a href="{{ route('users.edit', $data->id) }}" class="cursor-pointer flex p-2 m-1 rounded-md items-center bg-gradient-to-r from-yellow-400 to-amber-500 hover:bg-gradient-to-br hover:to-amber-400 text-white font-medium ">
