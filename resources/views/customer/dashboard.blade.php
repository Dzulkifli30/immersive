    ...
    <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
      <nav>
        ...
        <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
          ...
          <li class="text-sm pl-2 capitalize leading-normal text-slate-700 before:float-left before:pr-2 before:text-gray-600 before:content-['/']" aria-current="page">{{ Auth::user()->name }}</li>
        </ol>
  ...
  <div class="w-full px-6 py-6 mx-auto">
    ...
    <div class="flex flex-wrap mt-6 -mx-3">
      <div class="w-full px-3 mb-6 lg:mb-0 lg:flex-none text-center">
        <p class="text-6xl font-bold">INI DASHBOARD CIHUY.....</p>
      </div>
    </div>
  </div>
  <!-- end cards -->
